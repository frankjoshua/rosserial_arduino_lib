...
namespace sensor_msgs
{
    ...
    static const char sensor_msgs_PointCloud_type[] PROGMEM= "sensor_msgs/PointCloud";
    static const char sensor_msgs_PointCloud_md5[] PROGMEM= "d8e9c3f5afbdd8a130fd1d2763945fca";
