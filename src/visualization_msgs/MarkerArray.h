...
namespace visualization_msgs
{
    ...
    static const char visualization_msgs_MarkerArray_type[] PROGMEM= "visualization_msgs/MarkerArray";
    static const char visualization_msgs_MarkerArray_md5[] PROGMEM= "d155b9ce5188fbaf89745847fd5882d7";
