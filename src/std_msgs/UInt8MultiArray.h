...
namespace std_msgs
{
    ...
    static const char std_msgs_UInt8MultiArray_type[] PROGMEM= "std_msgs/UInt8MultiArray";
    static const char std_msgs_UInt8MultiArray_md5[] PROGMEM= "82373f1612381bb6ee473b5cd6f5d89c";
