...
namespace std_msgs
{
    ...
    static const char std_msgs_Int64MultiArray_type[] PROGMEM= "std_msgs/Int64MultiArray";
    static const char std_msgs_Int64MultiArray_md5[] PROGMEM= "54865aa6c65be0448113a2afc6a49270";
